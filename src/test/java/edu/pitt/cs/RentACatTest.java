...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		assertNull("Expected null", r.getCat(2));
	}
	...
	public void testGetCatNumCats3() {
		...
		r.addCat(c3);
		Cat c = r.getCat(2);
		assertNotNull("Cat is not null", c);
		assertEquals("ID of cat is 2", c.getId(), 2);
	}
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("catAvailable(2) should return false", res);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		c3.rentCat();
		boolean res = r.catAvailable(2);
		assertTrue("catAvailable(2) should return true", res);
	}
	...
	public void testCatExistsFalseNumCats0() {
		...
		assertFalse("catExists(2) should return false", res);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		boolean res = r.catExists(2);
		assertTrue("catExists(2) should return true", res);
	}
	...
	public void testListCatsNumCats0() {
		// TODO
		assertEquals("listCats() returns an empty string", "", r.listCats());
	}
	...
	public void testRentCatFailureNumCats0() {
		...
		assertFalse("rentCat(2) returns false", res);
	}
	...
	public void testReturnCatFailureNumCats0() {
		...
		assertFalse("returnCat(2) returns false", res);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("returnCat(2) returns true", res);
	}
}
